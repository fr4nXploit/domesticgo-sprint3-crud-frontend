...
export class ReseniaEliminarComponent {
  eliminando = false

  constructor(
    public dialogRef: MatDialogRef<ReseniaEliminarComponent>,
    @Inject(MAT_DIALOG_DATA) public data: Resenia,
  ...
  eliminar(): void {
    ...
    this.reseniaService.eliminar(this.data.idResenia).subscribe({
      next: () => {
        this.errorHandler.showSuccess("Reseña eliminada correctamente")
