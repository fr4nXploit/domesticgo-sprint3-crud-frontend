    ...
    <div class="dialog-container">
      ...
      <div class="dialog-content">
        <p class="dialog-message">
          ...
          <strong>{{data.nombres}} {{data.apellidoPaterno}}</strong>?
        </p>
...
export class UsuarioEliminarComponent {
  ...
  constructor(
    public dialogRef: MatDialogRef<UsuarioEliminarComponent>,
  ...
  eliminar(): void {
    ...
    this.usuarioService.eliminar(this.data.idUsuario).subscribe({
      next: () => {
